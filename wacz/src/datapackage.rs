...
pub struct DataPackageDigest<'a> {
    ...
    pub hash: Sha256Digest,
    /// A signature envelope as described by the
    /// [WACZ signing specification](https://specs.webrecorder.net/wacz-auth/latest/), preserved
    /// verbatim.
    #[serde(
        rename = "signedData",
        default,
    ...
    pub signed_data: Option<serde_json::Value>,
}
